...
public class HandManager : MonoBehaviour
{
    ...
    private void DrawCard()
    {
        ...
        var cardComponent = g.GetComponent<TidakFantasth.Card>();
        if (cardComponent != null)
        {
            cardComponent.SetOwnerHand(this);
            cardComponent.cardType = (TidakFantasth.Card.CardType)nextType;
        }
    ...
    public void ReturnCardToHand(TidakFantasth.Card card)
    {
